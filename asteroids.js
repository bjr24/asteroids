...
(function() {
  var Asteroid, Bullet, Coin, Drawable, FireBall, FireFlower, HealthBar, ImageLoader, Mushroom, PowerUp, Ship, Star, StarPowerUp, Vec2, asteroids, bindControls, bullets, canvas, canvasHeight, canvasWidth, coins, draw, drawBackground, fpsToInterval, frameRate, gameInit, healthBar, hits, images, numFireFlowersPickedUp, onLoad, powerUpCounter, powerUps, score, ship, spawnPowerup, stars, thrust, updateCoefficient, xformCanvas,
  ...
  draw = function() {
    var a, b, c, p, _i, _j, _k, _l, _len, _len1, _len2, _len3;
    drawBackground();
    ship.draw();
