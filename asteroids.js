...
(function() {
  var Asteroid, Bullet, Drawable, HealthBar, Ship, asteroids, bindControls, bullets, canvas, canvasHeight, canvasWidth, draw, fpsToInterval, frameRate, gameInit, healthBar, imageScaleScaleFactor, score, ship, thrust, updateCoefficient,
  ...
  HealthBar = (function() {
    ...
    HealthBar.prototype.draw = function() {
      ...
      try {
        ...
        return canvas.fillRect(this.x, this.y, this.width, height);
      } finally {
        canvas.restore();
      }
    };
