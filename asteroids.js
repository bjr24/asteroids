...
(function() {
  var Asteroid, Bullet, Drawable, Ship, asteroids, bindControls, bullets, canvas, canvasHeight, canvasWidth, circleRectIntersect, clamp, draw, fpsToInterval, frameRate, gameInit, imageScaleScaleFactor, ship, thrust, updateCoefficient,
  ...
  circleRectIntersect = function(cx, cy, radius, rLeft, rRight, rTop, rBottom) {
    var closestX, closestY, distSq, distX, distY;
  ...
  Asteroid = (function(_super) {
    ...
    function Asteroid(size, parent, hitter, first) {
      ...
      this.diameter = this.size / 6 * imageWidth;
      this.xForce = 0;
      this.yForce = 0;
      if (parent != null) {
        this.x = parent.x;
    ...
    Asteroid.prototype.render = function() {
      return canvas.drawImage(image, -this.diameter / 2, -this.diameter / 2, this.diameter, this.diameter);
    };
    ...
    Asteroid.prototype.update = function(dt) {
      ...
      for (_i = 0, _len = bullets.length; _i < _len; _i++) {
        b = bullets[_i];
        if (!(this.closeEnough(b, this.diameter))) {
          continue;
        }
        b.exists(false);
        hitter = b;
