...
(function() {
  var Asteroid, Bullet, Drawable, FireBall, FireFlower, HealthBar, ImageLoader, Mushroom, PowerUp, Ship, Star, StarPowerUp, Vec2, asteroids, bindControls, bullets, canvas, canvasHeight, canvasWidth, draw, drawBackground, fpsToInterval, frameRate, gameInit, healthBar, hits, images, numFireFlowersPickedUp, onLoad, powerUpCounter, powerUps, score, ship, spawnPowerup, stars, thrust, updateCoefficient, xformCanvas,
