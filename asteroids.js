...
(function() {
  var Asteroid, Bullet, Drawable, HealthBar, ImageLoader, PowerUp, Ship, Star, asteroids, bindControls, bullets, canvas, canvasHeight, canvasWidth, draw, drawBackground, fpsToInterval, frameRate, gameInit, healthBar, images, onLoad, powerUp, score, ship, stars, thrust, updateCoefficient, xformCanvas,
  ...
  PowerUp = (function(_super) {
    ...
    function PowerUp() {
      this.exists = __bind(this.exists, this);
      this.render = __bind(this.render, this);
      this.image = images.get("mushroom");
